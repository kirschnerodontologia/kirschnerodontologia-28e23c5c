      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-3">
            ...
            <p className="text-xs leading-relaxed font-body text-background/60">
          ...
          {/* Responsável Técnico */}
          <div className="space-y-3">
            <h3 className="text-sm font-display font-bold text-background uppercase">Responsável Técnico</h3>
            <div className="text-xs font-body text-background/60 space-y-1">
          ...
          {/* Contato */}
          <div className="space-y-3">
            <h3 className="text-sm font-display font-bold text-background uppercase">Contato</h3>
            <div className="text-xs font-body text-background/60 space-y-1">
          ...
          {/* Legal */}
          <div className="space-y-3">
            <h3 className="text-sm font-display font-bold text-background uppercase">Informações Legais</h3>
            <div className="text-xs font-body text-background/60 space-y-1">
              <p>CNPJ: Em registro</p>
              <p>
                Este site está em conformidade com a{" "}
                <strong className="text-background/80">Lei Geral de Proteção de Dados (LGPD)</strong> – Lei nº 13.709/2018.
              </p>
              <Link
